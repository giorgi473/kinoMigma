          ...
          <div className="h-full flex flex-col bg-black">
            ...
            {!mobileSubMenu && (
              <>
                ...
                <div className="flex items-center justify-between p-6 my-6">
                  <h2 className="text-white text-2xl font-semibold">გაფილტრე</h2>
                  <button
            ...
            {mobileSubMenu === "ფილმები" && (
              <>
                  ...
                  <h2 className="text-white text-2xl font-semibold">აირჩიეთ ფილმები</h2>
                </div>
                  ...
                  <div className="bg-zinc-900 rounded-lg mx-6 p-1 max-h-[calc(100vh-250px)] overflow-y-auto custom-scrollbar">
                    {filterCategories.ფილმები.map((option) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`w-5 h-5 rounded-full border-11 flex items-center justify-center shrink-0 ${
            ...
            {mobileSubMenu === "ჟანრი" && (
              <>
                <div className="flex items-center justify-center p-6 relative my-6">
                  ...
                  <h2 className="text-white text-2xl font-semibold">აირჩიეთ ჟანრი</h2>
                </div>
                <div className="flex-1 overflow-y-auto pb-24">
                ...
                <div className="p-6 mt-5">
                  <Button
                    onClick={() => setMobileSubMenu(null)}
                    className="w-full bg-yellow-500 hover:bg-yellow-600 text-white font-semibold rounded-lg py-7 text-lg"
                  >
                    არჩევა
                  </Button>
                </div>
            ...
            {mobileSubMenu === "რეიტინგი" && (
              <>
                <div className="flex items-center justify-center p-6 relative my-6">
                  ...
                  <h2 className="text-white text-2xl font-semibold">აირჩიეთ რეიტინგი</h2>
                </div>
            ...
            {mobileSubMenu === "ქვეყანა" && (
              <>
                <div className="flex items-center justify-center p-6 relative my-6">
                  ...
                  <h2 className="text-white text-2xl font-semibold">აირჩიეთ ქვეყანა</h2>
                </div>
                <div className="flex-1 overflow-y-auto pb-24">
                  <div className="bg-zinc-900 rounded-lg mx-6 p-1 max-h-[calc(70vh-250px)] overflow-y-auto custom-scrollbar">
            ...
            {mobileSubMenu === "წელი" && (
              <>
                  ...
                  <h2 className="text-white text-2xl font-semibold">აირჩიეთ წელი</h2>
                </div>
                <div className="flex-1 px-6 pb-6">
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      maxLength={4}
                      className="flex-1 bg-zinc-800 text-white px-4 py-3 w-3 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-yellow-500"
                    />
                    <span className="text-gray-400">•</span>
                    <input
                      type="text"
